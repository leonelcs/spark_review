...
public class AirportsMapGrouper implements MapGroupsFunction<String, Row, Row> {
    ...
    public Row call(String key, Iterator<Row> iterator) throws Exception {
        ...
        while(iterator.hasNext()) {
            ...
            int monthFlights = Integer.parseInt(current.getAs(flightsFieldIndex).toString());
            total += monthFlights;
            partialResults[Integer.parseInt(current.getAs(monthFieldIndex).toString()) - 1] += monthFlights;
        }
