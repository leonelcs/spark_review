...
public class DataFrameBasicsDBMain {
    ...
    private void init() throws Exception {
        ...
        Dataset<Row> results = df.withColumn("total_units_value",
                ...
                .withColumn("Bunda", concat(df.col("Series_title_1"), lit(" - "), df.col("Series_title_2")));
        ...
        //Print results in DB
        salesTransactionsDbManager.displayTableResults(5, String.format("SELECT * FROM %s", TABLE_NAME));
